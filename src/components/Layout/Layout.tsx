  ...
  (props, ref) => {
    ...
    const hasDOM = (content: string) => {
      return (
        ...
        children.some((item) => item.type.render.displayName === content)
      );
    };
    setTimeout(() => {
      let content: HTMLDivElement | null =
        document.querySelector(".speed-content");
      let layout: HTMLDivElement | null =
        document.querySelector(".speed-layout");
