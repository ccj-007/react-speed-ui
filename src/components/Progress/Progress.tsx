...
const Progress: FC<ProgressProps> = props => {
  ...
  const innerCls = classNames(`${prefixCls}-bar-inner`, `color-${theme}`, `${prefixCls}-bar-inner-${placement}`);
  ...
  return isCircle ? (
    <div className={`${prefixCls}-cir`} style={{ width: `${r * 2}px`, height: `${r * 2}px` }}>
    ...
    <div className={`${prefixCls}-bar`} style={styles}>
      <div className={`${prefixCls}-bar-outer`} style={{ height: `${strokeHeight}px` }}>
        <div
          className={innerCls}
          style={{ width: `${percent}%` }}
          css={css`
