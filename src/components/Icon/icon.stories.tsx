  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap' }}>
        ...
        <div className={prefixCls}>
          <Icon icon={solid('arrow-rotate-right')} size='5x' color='#4c4c4c'></Icon>
          arrow-rotate-right
        </div>
        <div className={prefixCls}>
        ...
        <div className={prefixCls}>
          <Icon icon={solid('magnifying-glass')} size='5x' color='#4c4c4c'></Icon>
          magnifying-glass
        </div>
        <div className={prefixCls}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap' }}>
        <div className={prefixCls}>
          <Icon icon={solid('spinner')} size='5x' color='#222222' className='fa-spin'></Icon>
          fa-spin
        </div>
        <div className={prefixCls}>
          <Icon icon={solid('check')} size='5x' color='#222222' className='fa-beat'></Icon>
          fa-beat
        </div>

        <div className={prefixCls}>
          <Icon icon={solid('comments')} size='5x' color='#222222' className='fa-fade'></Icon>
          fa-fade
        </div>
        <div className={prefixCls}>
          <Icon icon={solid('rss')} size='5x' color='#222222' className='fa-bounce'></Icon>
          fa-bounce
        </div>

        <div className={prefixCls}>
          <Icon icon={solid('user')} size='5x' color='#222222' className='fa-flip'></Icon>
          fa-flip
        </div>
        <div className={prefixCls}>
          <Icon icon={solid('house')} size='5x' color='#222222' className='fa-shake'></Icon>
          fa-shake
        </div>
      </div>
