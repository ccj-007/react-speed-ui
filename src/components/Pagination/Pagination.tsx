import React, { FC, useContext, useState, useEffect, HTMLInputTypeAttribute, useRef, RefObject, InputHTMLAttributes, ChangeEvent } from "react";
      ...
      <div className={`${prefixCls}`}>
        ...
        {/* 跳转页面 */}
        {
          ...
          <>
            ...
            <input className={`${prefixCls}-input`} ref={jumpRef} onChange={changeInput}></input>
        ...
        {/* 设置每页多少条 */}
        {
          editPageSize &&
          <>
            <input className={`${prefixCls}-input`} ref={sizeRef} onBlur={changeInputPageSize}></input>
